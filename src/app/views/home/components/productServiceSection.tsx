    ...
    <div className="md:max-h-screen">
      ...
      <div className="grid md:grid-cols-3 md:grid-rows-2 grid-flow-row md:grid-flow-row md:gap-0 gap-5 md:min-h-screen justify-items-center">
        <div className="md:content-start md:pl-10 px-10 md:min-w-full">
          <div className=" p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700 transition ease-in-out hover:-translate-y-1 hover:scale-105 duration-1000">
            ...
            <button type="button" className="text-white bg-blue-700  focus:ring-4 focus:outline-none focus:ring-blue-200 dark:bg-blue-600 dark:focus:ring-blue-900 font-medium rounded-lg text-sm px-5 py-2.5 inline-flex justify-center w-full text-center transition ease-in-out hover:bg-blue-800 duration-300">Choose plan</button>
          </div>
        </div>
        <div className="md:content-start md:pl-10 px-10 md:min-w-full">
          <div className=" p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700 transition ease-in-out hover:-translate-y-1 hover:scale-105 duration-1000">
